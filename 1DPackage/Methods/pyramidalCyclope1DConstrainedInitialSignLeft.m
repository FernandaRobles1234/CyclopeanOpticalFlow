...
PyrUpgrade1D[{v1_,v2_,status_,e_,dv1sign_},p0_, {{fline1_,dfline1_} ,{fline2_,dfline2_}}, threshold_,"ConstrainedInitialSign"]:=Block[{p1, p2, c,d1,d2,dv1,dv2},(
...
(* we feed new dv1sign... *)
Return[PyrUpgrade1D[{v1,v2,"oksign",e,(fline1[p1]-c)/-(d1)},p0, {{fline1,dfline1} ,{fline2,dfline2}}, threshold,"ConstrainedInitialSign"]],
Return[PyrUpgrade1D[{v1,v2,"oksign",e,dv1sign},p0, {{fline1,dfline1} ,{fline2,dfline2}}, threshold,"ConstrainedInitialSign"]]
]
,
Return[{0.,0.,"sign",e,0.}]
]
...
PyrUpgrade1D[{v1_,v2_,"oksign",e_,dv1sign_},p0_, {{fline1_,dfline1_} ,{fline2_,dfline2_}}, threshold_,"ConstrainedInitialSign"]:=Block[{p1,p2,c,d1,d2,dv1,dv2,r0},(
...
PyrUpgrade1D[{v1_,v2_,status_,2,dv1sign_},p0_, {{fline1_,dfline1_} ,{fline2_,dfline2_}}, threshold_,"ConstrainedInitialSign"]:=Return[{0.,0.,status,2,0.}];

PyrUpgrade1D[{v1_,v2_,"sign",e_,dv1sign_},p0_, {{fline1_,dfline1_} ,{fline2_,dfline2_}}, threshold_,"ConstrainedInitialSign"]:=Return[{v1,v2,"sign",e,dv1sign}];

PyrUpgrade1D[{v1_,v2_,"mag",e_,dv1sign_},p0_, {{fline1_,dfline1_} ,{fline2_,dfline2_}}, threshold_,"ConstrainedInitialSign"]:=Return[{v1,v2,"mag",e,dv1sign}];

PyrUpgrade1D[{v1_,v2_,"flip",e_,dv1sign_},p0_, {{fline1_,dfline1_} ,{fline2_,dfline2_}}, threshold_,"ConstrainedInitialSign"]:=Return[{v1,v2,"flip",e,dv1sign}];
