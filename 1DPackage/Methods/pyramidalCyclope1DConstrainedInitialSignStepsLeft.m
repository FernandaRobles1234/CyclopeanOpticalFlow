...
(* we feed new dv1sign... *)
Return[PyrUpgrade1D[{v1,v2,"oksign",e,(fline1[p1]-c)/-(d1)},p0, {{fline1,dfline1} ,{fline2,dfline2}}, threshold,"ConstrainedInitialSignStepsLeft"]],
Return[PyrUpgrade1D[{v1,v2,"oksign",e,dv1sign},p0, {{fline1,dfline1} ,{fline2,dfline2}}, threshold,"ConstrainedInitialSignStepsLeft"]]
]
,
Return[{0.,0.,"sign",e,0.}]
]
...
PyrUpgrade1D[{v1_,v2_,"oksign",e_,dv1sign_},p0_, {{fline1_,dfline1_} ,{fline2_,dfline2_}}, threshold_,"ConstrainedInitialSignStepsLeft"]:=Block[{fric1,fric2,p1,p2,c,d1,d2,dv1,dv2,r0},(
...
PyrUpgrade1D[{v1_,v2_,status_,2,dv1sign_},p0_, {{fline1_,dfline1_} ,{fline2_,dfline2_}}, threshold_,"ConstrainedInitialSignStepsLeft"]:=Return[{0.,0.,status,2,0.}];

PyrUpgrade1D[{v1_,v2_,"sign",e_,dv1sign_},p0_, {{fline1_,dfline1_} ,{fline2_,dfline2_}}, threshold_,"ConstrainedInitialSignStepsLeft"]:=Return[{v1,v2,"sign",e,dv1sign}];

PyrUpgrade1D[{v1_,v2_,"mag",e_,dv1sign_},p0_, {{fline1_,dfline1_} ,{fline2_,dfline2_}}, threshold_,"ConstrainedInitialSignStepsLeft"]:=Return[{v1,v2,"mag",e,dv1sign}];

PyrUpgrade1D[{v1_,v2_,"flip",e_,dv1sign_},p0_, {{fline1_,dfline1_} ,{fline2_,dfline2_}}, threshold_,"ConstrainedInitialSignStepsLeft"]:=Return[{v1,v2,"flip",e,dv1sign}];
...
(* ::Input::Initialization:: *)
PyrFlow1D[i_, p0_, pyrfunctions_,threshold_,"ConstrainedInitialSignStepsLeft"]:=Block[{v1, v2,c,d,dd,cc,status,e,dv1sign,iterTable,updateValues},(
...
iterTable=Table[
updateValues=PyrUpgrade1D[updateValues,p0, pyrfunctions[[-f]],threshold*2^(-c+1),"ConstrainedInitialSignStepsLeft"];
...
PyrFlow1DIter[i_, p0_,v0_, pyrfunctions_,threshold_,"ConstrainedInitialSignStepsLeft"]:=Block[{v1, v2,c,status,iterTable,updateValues},(
