...
PyrUpgrade1D[{v1_,v2_,"oksign",e_,dv1sign_,dv2sign_},p0_, {{fline1_,dfline1_} ,{fline2_,dfline2_}}, threshold_,"ConstrainedInitialSignStepsLeftRight"]:=Block[{fric1,fric2,p1,p2,c,d1,d2,dv1,dv2,r0},(
...
PyrUpgrade1D[{v1_,v2_,status_,2,dv1sign_,dv2sign_},p0_, {{fline1_,dfline1_} ,{fline2_,dfline2_}}, threshold_,"ConstrainedInitialSignStepsLeftRight"]:=Return[{0.,0.,status,2,0.,0.}];

PyrUpgrade1D[{v1_,v2_,"sign",e_,dv1sign_,dv2sign_},p0_, {{fline1_,dfline1_} ,{fline2_,dfline2_}}, threshold_,"ConstrainedInitialSignStepsLeftRight"]:=Return[{v1,v2,"sign",e,dv1sign,dv2sign}];

PyrUpgrade1D[{v1_,v2_,"mag",e_,dv1sign_,dv2sign_},p0_, {{fline1_,dfline1_} ,{fline2_,dfline2_}}, threshold_,"ConstrainedInitialSignStepsLeftRight"]:=Return[{v1,v2,"mag",e,dv1sign,dv2sign}];

PyrUpgrade1D[{v1_,v2_,"flip",e_,dv1sign_,dv2sign_},p0_, {{fline1_,dfline1_} ,{fline2_,dfline2_}}, threshold_,"ConstrainedInitialSignStepsLeftRight"]:=Return[{v1,v2,"flip",e,dv1sign,dv2sign}];
...
(* ::Input::Initialization:: *)
PyrFlow1D[i_, p0_, pyrfunctions_,threshold_,"ConstrainedInitialSignStepsLeftRight"]:=Block[{v1, v2,c,d,dd,cc,status,e,dv1sign,iterTable,updateValues},(
...
iterTable=Table[
updateValues=PyrUpgrade1D[updateValues,p0, pyrfunctions[[-f]],threshold*2^(-c+1),"ConstrainedInitialSignStepsLeftRight"];
...
PyrFlow1DIter[i_, p0_,v0_, pyrfunctions_,threshold_,"ConstrainedInitialSignStepsLeftRight"]:=Block[{v1, v2,c,status,iterTable,updateValues},(
