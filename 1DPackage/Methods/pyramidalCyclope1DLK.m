...
Input\[Rule] [{v1,v2,status,e},p0,{{f1,df1},{f2,df2},threshold,mode}
Output-> {v1,v2,status}
v1= Solution of f1
v2= Solution of f2
...
pixelIter[i_, p0_, pyrfunctions_,threshold_,mode_]:=pixelIter[i, p0,{0.,0.}, pyrfunctions,threshold,mode];
...
(* Makes iterations by saving all the values *)
iter=pixelIter[i,p0,v0, pyrfunctions,threshold,mode];
Flatten[Table[
(* Makes plots only for one level *)
...
Output-> {rangex, {v1,v2,status,e} parfois {v1,v2,status} }
";
