...
(* ::Input::Initialization:: *)
findPrevNext[p0_,{v1_,v2_},{dfline1_,dfline2_}]:=Block[{continue,notcontinue, resFunc, sumFunc,r1left,rleft,r2left,r1right,r2right,rright},(

continue[p_]:=Sign[dfline1[p]*dfline2[p0+v2]]==-1;
notcontinue[p_]:=Sign[dfline1[p]*dfline2[p0+v2]]==1;
resFunc[p_]:=p-0.1;

r1left=NestWhile[resFunc,p0-v1,continue,1,100];
...
r0=findPrevNext[p0,{v1,v2}{dfline1,dfline2}];
(*Print[r0];*)
p1=r0-v1;
p2=r0+v2;
